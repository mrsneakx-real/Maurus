param(
    [string]$Title = "Turn on virus protection",
    [string]$Message = "Microsoft Defender Antivirus is now turned off.",
    [string]$ImagePath = "C:\Program Files (x86)\Maurus\defender.png"
)
...
# Play sound
$SoundPath = "C:\Program Files (x86)\Maurus\winerror.wav"
